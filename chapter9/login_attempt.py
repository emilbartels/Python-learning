...
#users
echmil = User('Emil', 'Sørensen', 'Echmil', 'Emilbartels3001@gmail.com', 'Liv2811!')
seal = User('William', 'Westh', 'Seal', 'Klaussørensen12@gmail.com', 'sealerflot123')
magnum = User('Magnus', 'Villadsen', 'Mavrit', 'magnuspixelmon@gmail.com', 'Mavritus12!')

#Beskrivelse af users gennem methods
echmil.set_login(0)
echmil.greet_user()
echmil.describe_user()
echmil.increment_logins_attempted()
echmil.increment_logins_attempted()
echmil.increment_logins_attempted()
echmil.increment_logins_attempted()
echmil.reset_logins_attempted()
echmil.increment_logins_attempted()

seal.greet_user()
seal.describe_user()
seal.increment_logins_attempted()

magnum.greet_user()
magnum.describe_user()
magnum.increment_logins_attempted()
